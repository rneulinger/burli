...
class GenGUI(s: String) {
  ...
  val frame = new JFrame(s"Coreo Define Frame")
  val layout = BorderLayout()
  frame.setLayout(layout);

  // button
  val northPanel = JPanel();
  northPanel.setPreferredSize(new java.awt.Dimension(200, 50))
  ...
  westPanel.setPreferredSize(new java.awt.Dimension(200, 300))
  ...
  eastPanel.setPreferredSize(new java.awt.Dimension(400, 300))
  ...
  southPanel.setPreferredSize(new java.awt.Dimension(200, 50))
